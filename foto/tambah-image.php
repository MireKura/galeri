        ...
        <div class="container">
            ...
            <div class="box">
               ...
               <form action="" method="POST" enctype="multipart/form-data">
                   ...
                   <?php   $result = mysqli_query($conn,"select * from tb_jurusan");   $jsArray = "var prdName = new Array();\n";   
...
$jsArray .= "prdName['" . $row['category_id'] . "'] = '" . addslashes($row['category_name']) . "';\n";}echo '</select>';?>
                   ...
                   <input type="text" name="namauser" class="input-control" value="<?php echo $_SESSION['a_global']->user_name ?>" readonly="readonly">
