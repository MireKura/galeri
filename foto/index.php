...
<body>
    ...
    <header>
        ...
        <ul>
           ...
           <li><a href="imageedit/index.html">Edit Foto</a></li>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box">
                <?php
                    $kategori = mysqli_query($conn, "SELECT * FROM tb_jurusan ORDER BY category_id DESC");
    ...
    <!-- footer -->
     <footer>
        ...
        <div class="container">
        <li><a href="galeri.php"><img src="img/galeri.png" width="50px" style="margin-bottom:5px;" /></a></li>
        </div>    
    </footer>
</body>
</html>